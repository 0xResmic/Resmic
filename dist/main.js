...
const $08c87f9bb5c02156$export$d59696070647f03c = [
    "Ethereum",
    "Polygon",
    "Starknet",
    "Binance",
...
const $08c87f9bb5c02156$export$c3f32f9b7c2f46bb = {
    "Ethereum": {
        "name": "Ethereum",
        "description": "",
        "id": "0x1",
...
const $08c87f9bb5c02156$export$8e1e81ac145e31be = {
...
const $08c87f9bb5c02156$export$3765b2c107be43ec = [
    {
        "members": [
            {
                "name": "low",
...
async function $c7536a635f4aea01$export$cfaea2bb8d8b8829() {
    let account;
    let currentChainId;
...
async function $c7536a635f4aea01$export$f3473d805e486329(networkId) {
    try {
        await window.ethereum.request({
...
async function $c7536a635f4aea01$export$57632def5536cb24() {
    const provider = new (0, $ezI6v$ethers.ethers).providers.Web3Provider(window.ethereum);
    return provider;
}
async function $c7536a635f4aea01$export$c128ec6fd8bee8d4() {
    const provider = new (0, $ezI6v$ethers.ethers).providers.Web3Provider(window.ethereum);
...
const $7b48652aa1e398c2$export$6c774fdbdbcfd895 = async (_token)=>{
...
async function $7e58398fd3a5ec86$export$1213dd6fecdd48f0(Blockchain, Token, Address_, Amount, PaymentConfirmations = 2) {
    ...
    /*
        ...
        ii. Stable tokens
        iii. Unstable tokens.
    */ let tokenType = (0, $08c87f9bb5c02156$export$8e1e81ac145e31be)[Token];
    if ((tokenType === null || tokenType === void 0 ? void 0 : tokenType.id) === requiredChainID) {
        var _Tokens_Token;
        let tokenSymbol = (_Tokens_Token = (0, $08c87f9bb5c02156$export$8e1e81ac145e31be)[Token]) === null || _Tokens_Token === void 0 ? void 0 : _Tokens_Token.dname;
        let nativePayment = await $7e58398fd3a5ec86$var$nativeTokenPayment(Amount, Address, tokenSymbol, PaymentConfirmations);
        ...
        var _Tokens_Token1;
        let tokenSymbol = (_Tokens_Token1 = (0, $08c87f9bb5c02156$export$8e1e81ac145e31be)[Token]) === null || _Tokens_Token1 === void 0 ? void 0 : _Tokens_Token1.dname;
        let tokenAddress = (0, $08c87f9bb5c02156$export$5c2c3f7af123bc40);
        tokenAddress = tokenAddress[Blockchain][Token];
        // Calculate the amount here.
        let livePrice = await (0, $7b48652aa1e398c2$export$6c774fdbdbcfd895)(tokenSymbol);
        let amount = Amount / livePrice;
        amount = parseFloat(amount);
        let ERC20tx = await $7e58398fd3a5ec86$var$requestERC20Payment(amount, tokenAddress, connectdUserAddress, Address, PaymentConfirmations);
...
*/ const $7e58398fd3a5ec86$var$nativeTokenPayment = async (_amount, _address, _tokenSymbol, _paymentConfirmations)=>{
    ...
    let amount = _amount;
    let liveTokenPrice = await (0, $7b48652aa1e398c2$export$6c774fdbdbcfd895)(_tokenSymbol) // Live token price
    ;
    let decimal = 18;
    let tokenAmount = amount / liveTokenPrice;
    tokenAmount = (0, ($parcel$interopDefault($ezI6v$bignumberjs)))(parseInt(tokenAmount * 10 ** decimal));
    ...
    try {
        ...
        await tx.wait();
        let paymentUpdate = await $7e58398fd3a5ec86$var$checkBlockConformationsNative(tx.hash, tokenAmount, _paymentConfirmations, _tokenSymbol);
...
*/ const $7e58398fd3a5ec86$var$checkBlockConformationsNative = async (tx, _amount, _noOfBlockConformation, _tokenSymbol)=>{
    let provider = await (0, $c7536a635f4aea01$export$57632def5536cb24)();
    ...
    if (receipt.status === 1) {
        let actualTokenTransfer = await $7e58398fd3a5ec86$var$checkTokenTransfersNative(tx); // It retunes the actual tokens received at the blockchain.
...
/**
   ...
   */ const $7e58398fd3a5ec86$var$checkTokenTransfersNative = async (tx)=>{
    let provider = await (0, $c7536a635f4aea01$export$57632def5536cb24)();
    try {
        ...
        if (transaction && transaction.confirmations > 0) {
            ...
            amountInWei = (0, ($parcel$interopDefault($ezI6v$bignumberjs)))(amountInWei.toString());
...
/**
   ...
   * 
   */ const $7e58398fd3a5ec86$var$requestERC20Payment = async (_amount, _tokenAddress, _userAddress, _toAddress, _paymentConfirmations)=>{
    // setIsLoading(true);
    const signer = await (0, $c7536a635f4aea01$export$c128ec6fd8bee8d4)();
    try {
        /**
       ...
       */ const contractInstance = new (0, $ezI6v$ethers.ethers).Contract(_tokenAddress, (0, $08c87f9bb5c02156$export$89843982d7e60b14), signer);
        let decimals = await contractInstance.decimals();
        decimals = decimals.toString();
        let amount = _amount;
        amount = (0, ($parcel$interopDefault($ezI6v$bignumberjs)))(parseInt(amount * 10 ** decimals));
        ...
        await tx.wait();
        let tx2 = await $7e58398fd3a5ec86$var$checkBlockConformations(tx.hash, amount, _paymentConfirmations, _tokenAddress);
        return tx2;
    } catch (error) {
        (0, $ezI6v$reacttoastify.toast).error("Something went wrong.", {
            position: (0, $ezI6v$reacttoastify.toast).POSITION.TOP_CENTER,
...
/**
   ...
   * @returns {Bool} returns the paymetn update.
   */ const $7e58398fd3a5ec86$var$checkBlockConformations = async (tx, _amount, _noOfBlockConformation, _tokenAddress)=>{
    let provider = await (0, $c7536a635f4aea01$export$57632def5536cb24)();
    const confirmationsRequired = _noOfBlockConformation;
    const receipt = await provider.waitForTransaction(tx, confirmationsRequired);
    // Checks the status of the transaction
    if (receipt.status === 1) {
        let actualTokenTransfer = await $7e58398fd3a5ec86$var$checkTokenTransfers(tx, _tokenAddress);
        if (actualTokenTransfer !== "0") {
...
/**
   ...
   * @param {String} _tokenAddress
   * @returns {String} String '0' or 'Amount_Of_Tokens'
   */ const $7e58398fd3a5ec86$var$checkTokenTransfers = async (transactionHash, _tokenAddress)=>{
    let provider = await (0, $c7536a635f4aea01$export$57632def5536cb24)();
    try {
        const transactionReceipt = await provider.getTransactionReceipt(transactionHash);
        if (transactionReceipt && transactionReceipt.status === 1) {
            const tokenContract = new (0, $ezI6v$ethers.ethers).Contract(_tokenAddress, (0, $08c87f9bb5c02156$export$89843982d7e60b14), provider);
...
async function $79385d6deea39a30$export$ef880f08cac7f8c(Token, Address_, Amount, PaymentConfirmation = 2) {
    ...
    let connectVar = await (0, $b51e9211bc6a0a77$export$43158100a9ac6874)();
    ...
    let tokenAddress = (0, $08c87f9bb5c02156$export$5c2c3f7af123bc40)["Starknet"][Token];
    let tokenDetails = (0, $08c87f9bb5c02156$export$8e1e81ac145e31be)[Token];
    if (tokenDetails.type === "unstable") {
        let liveTokenPrice = await (0, $7b48652aa1e398c2$export$6c774fdbdbcfd895)(tokenDetails.dname);
        let amount = Amount / liveTokenPrice;
        let tx = await $79385d6deea39a30$var$requestERC20Payment(amount, tokenAddress, Address, userAddress, provider, signer, PaymentConfirmation, connectVar);
        return tx;
    } else {
        let tx = await $79385d6deea39a30$var$requestERC20Payment(Amount, tokenAddress, Address, userAddress, provider, signer, PaymentConfirmation, connectVar);
        return tx;
 ...
 * @returns 
 */ const $79385d6deea39a30$var$requestERC20Payment = async (_tokenAmount, _tokenAddress, _toAddress, _fromAddress, _provider, _signer, _blockConfirmations, _starknetObj)=>{
    ...
    try {
        let transferToken = await _starknetObj.account.execute({
            ...
            calldata: (0, $ezI6v$starknet.CallData).compile({
                ...
                amount: (0, $ezI6v$starknet.cairo).uint256(parseInt(tokenAmount))
            })
        });
        ...
        if (finalStatus === "ACCEPTED_ON_L2") {
            ...
            let update = await $79385d6deea39a30$var$verifyTransaction(transferToken.transaction_hash, tokenAmount, provider, _toAddress, _fromAddress, _tokenAddress, decimal);
            if (update) {
 ...
 * @returns 
 */ const $79385d6deea39a30$var$verifyTransaction = async (_txHash, _latestAmount, _provider, _toAddress, _fromAddress, _tokenAddress, _decimal)=>{
 ...
 */ function $b89d8898fa798274$var$CryptoPayment({ Address: Address, Tokens: Tokens, Chains: Chains, Amount: Amount, noOfBlockConformation: noOfBlockConformation, setPaymentStatus: setPaymentStatus, Style: Style = {
    ...
    const [isAllSelected, setIsAllSelected] = (0, $ezI6v$react.useState)(false); // If Bockchain and Token are selected & Clicked on make payment, The Dropdown will be disabled.
     ...
     */ const makePayment = async ()=>{
        if (selectedBlockchain === "" || selectedToken === "") (0, $ezI6v$reacttoastify.toast).warning("Please select payment method", {
            position: (0, $ezI6v$reacttoastify.toast).POSITION.TOP_CENTER,
            theme: "dark"
        });
            ...
            default:
                setIsLoading(true);
                let makePaymentEVM = await (0, $7e58398fd3a5ec86$export$1213dd6fecdd48f0)(selectedBlockchain, selectedToken, Address, Amount, noOfBlockConformation);
    ...
    return /*#__PURE__*/ (0, $ezI6v$reactjsxruntime.jsxs)((0, $ezI6v$reactjsxruntime.Fragment), {
        children: [
            ...
            isPopUpOpen && /*#__PURE__*/ (0, $ezI6v$reactjsxruntime.jsx)("div", {
                            ...
                            children: /*#__PURE__*/ (0, $ezI6v$reactjsxruntime.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, $ezI6v$reactjsxruntime.jsxs)("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, $ezI6v$reactjsxruntime.jsx)("label", {
