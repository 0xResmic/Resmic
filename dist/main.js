...
var $gXNCa$starknet = require("starknet");
var $gXNCa$getstarknet = require("get-starknet");
...
$parcel$export(module.exports, "StarknetConnect", () => $203af01f631c2a4e$export$2e2bcd8739ae039);
...
async function $61e4b7aa7a6ba749$export$43158100a9ac6874() {
    try {
        let con = await (0, $gXNCa$getstarknet.connect)();
        return con;
    } catch (error) {
        console.log(error);
        (0, $gXNCa$reacttoastify.toast).error("Unable to connect wallet.", {
            position: (0, $gXNCa$reacttoastify.toast).POSITION.TOP_CENTER,
            theme: "dark"
        });
    }
...
var $2b36d78ad8d885cf$exports = {};

$parcel$export($2b36d78ad8d885cf$exports, "StarknetTokenAddress", () => $2b36d78ad8d885cf$export$3dd05bcec6d502);
$parcel$export($2b36d78ad8d885cf$exports, "StarkTokens", () => $2b36d78ad8d885cf$export$abf328e0fa55cf1f);
$parcel$export($2b36d78ad8d885cf$exports, "STARKNET_ERC20_ABI", () => $2b36d78ad8d885cf$export$3765b2c107be43ec);
const $2b36d78ad8d885cf$export$3dd05bcec6d502 = {
...
const $2b36d78ad8d885cf$export$abf328e0fa55cf1f = {
    USDT: {
        "name": "USDT",
        "type": "stable",
        "id": "-1",
...
const $2b36d78ad8d885cf$export$3765b2c107be43ec = [
    {
        "members": [
            {
                "name": "low",
 ...
 */ function $203af01f631c2a4e$var$StarkNetComponent({ Address: Address, Tokens: Tokens, Amount: Amount, setPaymentStatus: setPaymentStatus, Style: Style = {
    displayName: "Make Payment",
    backgroundColor: "#007bff",
    color: "#fff",
    border: "none",
    ...
    const [selectedToken, setSelectedToken] = (0, $gXNCa$react.useState)(null);
    const [isConnected, setIsConnected] = (0, $gXNCa$react.useState)(false);
    const [starknetObject, setStarknetObject] = (0, $gXNCa$react.useState)();
    const [userAddress, setUserAddress] = (0, $gXNCa$react.useState)();
    const [providerUrl, setProviderUrl] = (0, $gXNCa$react.useState)();
    const [isPopupOpen, setIsPopupOpen] = (0, $gXNCa$react.useState)(false);
    const [isLoading, setIsLoading] = (0, $gXNCa$react.useState)(false);
    const [currentAmount, setCurrentAmount] = (0, $gXNCa$react.useState)();
    const [currentTokenPrice, setCurrentTokenPrice] = (0, $gXNCa$react.useState)(""); // To display the conversion rate for token.
    const [btnName, setBtnName] = (0, $gXNCa$react.useState)("Make Payment");
    // Select Token dropdown selection menu.
    let selectToken = Tokens.map((token)=>{
        return /*#__PURE__*/ (0, $gXNCa$reactjsxruntime.jsxs)((0, $gXNCa$reactjsxruntime.Fragment), {
            children: [
     ...
     */ const connectStarknetWallet = async ()=>{
        setIsLoading(true);
        let connect = await (0, $61e4b7aa7a6ba749$export$43158100a9ac6874)();
     ...
     */ const requestERC20Payment = async (latestAmount, _selectedToken)=>{
        ...
        const provider = new (0, $gXNCa$starknet.Provider)({
            sequencer: {
                baseUrl: providerUrl
            }
        });
        const contractInstance = new (0, $gXNCa$starknet.Contract)((0, $2b36d78ad8d885cf$export$3765b2c107be43ec), (0, $2b36d78ad8d885cf$export$3dd05bcec6d502)[_selectedToken], provider);
        let _contractAddress = (0, $2b36d78ad8d885cf$export$3dd05bcec6d502)[_selectedToken];
        ...
        try {
            ...
            let approveTokens = await starknetObject.account.execute({
                ...
                entrypoint: "approve",
                calldata: (0, $gXNCa$starknet.CallData).compile({
                    recipient: userAddress,
                    // amount: cairo.uint256(_latestAmount)
                    amount: (0, $gXNCa$starknet.cairo).uint256(parseInt(_latestAmount.toString()))
                })
            });
            ...
            (0, $gXNCa$reacttoastify.toast).success("Token transferred successfully", {
                position: (0, $gXNCa$reacttoastify.toast).POSITION.TOP_CENTER,
                theme: "dark"
            });
            ...
            (0, $gXNCa$reacttoastify.toast).error("Unable to make payment!", {
                position: (0, $gXNCa$reacttoastify.toast).POSITION.TOP_CENTER,
                theme: "dark"
            });
        }
     ...
     */ const verifyTransaction = async (_txHash, _latestAmount)=>{
        ...
        const contractInstance = new (0, $gXNCa$starknet.Contract)((0, $2b36d78ad8d885cf$export$3765b2c107be43ec), (0, $2b36d78ad8d885cf$export$3dd05bcec6d502)[selectedToken?.name], provider);
        ...
        if (tokenTransferedAmount >= _amount && tokenTransferedToAddress.toLowerCase() === Address.toLowerCase() && tokenTransferedFromAddress.toLowerCase() === userAddress.toLowerCase() && tokenAddressOfTransferToken.toLowerCase() === (0, $2b36d78ad8d885cf$export$3dd05bcec6d502)[selectedToken?.name].toLowerCase()) verificationStatue = true;
...
var $203af01f631c2a4e$export$2e2bcd8739ae039 = $203af01f631c2a4e$var$StarkNetComponent;




$parcel$exportWildcard(module.exports, $0578d5b47142f887$exports);
$parcel$exportWildcard(module.exports, $2b36d78ad8d885cf$exports);
