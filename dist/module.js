...
import {Provider as $5OpyM$Provider, Contract as $5OpyM$Contract, CallData as $5OpyM$CallData, cairo as $5OpyM$cairo} from "starknet";
import {connect as $5OpyM$connect} from "get-starknet";
...
async function $f5b439426d7fa6ef$export$43158100a9ac6874() {
    try {
        let con = await (0, $5OpyM$connect)();
        return con;
    } catch (error) {
        console.log(error);
        (0, $5OpyM$toast).error("Unable to connect wallet.", {
            position: (0, $5OpyM$toast).POSITION.TOP_CENTER,
            theme: "dark"
        });
    }
...
var $057d4491b3bb0188$exports = {};

$parcel$export($057d4491b3bb0188$exports, "StarknetTokenAddress", () => $057d4491b3bb0188$export$3dd05bcec6d502);
$parcel$export($057d4491b3bb0188$exports, "StarkTokens", () => $057d4491b3bb0188$export$abf328e0fa55cf1f);
$parcel$export($057d4491b3bb0188$exports, "STARKNET_ERC20_ABI", () => $057d4491b3bb0188$export$3765b2c107be43ec);
const $057d4491b3bb0188$export$3dd05bcec6d502 = {
...
const $057d4491b3bb0188$export$abf328e0fa55cf1f = {
    USDT: {
        "name": "USDT",
        "type": "stable",
        "id": "-1",
...
const $057d4491b3bb0188$export$3765b2c107be43ec = [
    {
        "members": [
            {
                "name": "low",
 ...
 */ function $813dd223ffc50372$var$StarkNetComponent({ Address: Address, Tokens: Tokens, Amount: Amount, setPaymentStatus: setPaymentStatus, Style: Style = {
    displayName: "Make Payment",
    backgroundColor: "#007bff",
    color: "#fff",
    border: "none",
    ...
    const [selectedToken, setSelectedToken] = (0, $5OpyM$useState)(null);
    const [isConnected, setIsConnected] = (0, $5OpyM$useState)(false);
    const [starknetObject, setStarknetObject] = (0, $5OpyM$useState)();
    const [userAddress, setUserAddress] = (0, $5OpyM$useState)();
    const [providerUrl, setProviderUrl] = (0, $5OpyM$useState)();
    const [isPopupOpen, setIsPopupOpen] = (0, $5OpyM$useState)(false);
    const [isLoading, setIsLoading] = (0, $5OpyM$useState)(false);
    const [currentAmount, setCurrentAmount] = (0, $5OpyM$useState)();
    const [currentTokenPrice, setCurrentTokenPrice] = (0, $5OpyM$useState)(""); // To display the conversion rate for token.
    const [btnName, setBtnName] = (0, $5OpyM$useState)("Make Payment");
    // Select Token dropdown selection menu.
    let selectToken = Tokens.map((token)=>{
        return /*#__PURE__*/ (0, $5OpyM$jsxs)((0, $5OpyM$Fragment), {
            children: [
     ...
     */ const connectStarknetWallet = async ()=>{
        setIsLoading(true);
        let connect = await (0, $f5b439426d7fa6ef$export$43158100a9ac6874)();
     ...
     */ const requestERC20Payment = async (latestAmount, _selectedToken)=>{
        ...
        const provider = new (0, $5OpyM$Provider)({
            sequencer: {
                baseUrl: providerUrl
            }
        });
        const contractInstance = new (0, $5OpyM$Contract)((0, $057d4491b3bb0188$export$3765b2c107be43ec), (0, $057d4491b3bb0188$export$3dd05bcec6d502)[_selectedToken], provider);
        let _contractAddress = (0, $057d4491b3bb0188$export$3dd05bcec6d502)[_selectedToken];
        ...
        try {
            ...
            let approveTokens = await starknetObject.account.execute({
                ...
                entrypoint: "approve",
                calldata: (0, $5OpyM$CallData).compile({
                    recipient: userAddress,
                    // amount: cairo.uint256(_latestAmount)
                    amount: (0, $5OpyM$cairo).uint256(parseInt(_latestAmount.toString()))
                })
            });
            ...
            (0, $5OpyM$toast).success("Token transferred successfully", {
                position: (0, $5OpyM$toast).POSITION.TOP_CENTER,
                theme: "dark"
            });
            ...
            (0, $5OpyM$toast).error("Unable to make payment!", {
                position: (0, $5OpyM$toast).POSITION.TOP_CENTER,
                theme: "dark"
            });
        }
     ...
     */ const verifyTransaction = async (_txHash, _latestAmount)=>{
        ...
        const contractInstance = new (0, $5OpyM$Contract)((0, $057d4491b3bb0188$export$3765b2c107be43ec), (0, $057d4491b3bb0188$export$3dd05bcec6d502)[selectedToken?.name], provider);
        ...
        if (tokenTransferedAmount >= _amount && tokenTransferedToAddress.toLowerCase() === Address.toLowerCase() && tokenTransferedFromAddress.toLowerCase() === userAddress.toLowerCase() && tokenAddressOfTransferToken.toLowerCase() === (0, $057d4491b3bb0188$export$3dd05bcec6d502)[selectedToken?.name].toLowerCase()) verificationStatue = true;
        return verificationStatue;
    };
    /**
     * Super function to call all the functions in sync.
     */ const makePayment = async ()=>{
        if (selectedToken?.name == null) // alert("Please select the payment mode")
        (0, $5OpyM$toast).warning("Please select the payment mode", {
            position: (0, $5OpyM$toast).POSITION.TOP_CENTER,
            theme: "dark"
        });
...
var $813dd223ffc50372$export$2e2bcd8739ae039 = $813dd223ffc50372$var$StarkNetComponent;
...
export {$c3da8292154b5c08$export$2e2bcd8739ae039 as EVMConnect, $813dd223ffc50372$export$2e2bcd8739ae039 as StarknetConnect, $d896c950a751df0f$export$5c2c3f7af123bc40 as TokenAddress, $d896c950a751df0f$export$c3f32f9b7c2f46bb as Chains, $d896c950a751df0f$export$8e1e81ac145e31be as Tokens, $d896c950a751df0f$export$89843982d7e60b14 as ERC20_ABI, $057d4491b3bb0188$export$3dd05bcec6d502 as StarknetTokenAddress, $057d4491b3bb0188$export$abf328e0fa55cf1f as StarkTokens, $057d4491b3bb0188$export$3765b2c107be43ec as STARKNET_ERC20_ABI};
